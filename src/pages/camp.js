...
export default ({ data }) => (
<div>
<Helmet><title>Brain Camp | Get with the Program</title></Helmet>
<Layout>
<div>

    {/* jumbotron */}
    <div class="jumbotron jumbotron-fluid bg-dark text-white mb-0 camp">
    ...
    {/* past-programs */}
    <div id="past" class="py-5 bg-green">
        <div class="container">
